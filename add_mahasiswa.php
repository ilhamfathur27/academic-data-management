...
<?php
  ...
  if (isset($_POST['Submit'])){
    ...
    $prodi = $_POST['id_program_studi'];
	

    //insert user into table
    $result = mysqli_query($connection, "INSERT INTO mahasiswa VALUES ('$nrp','$nama','$tanggal_lahir','$prodi')");
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          ...
          <form action="add_mahasiswa.php" method="post" enctype="multipart/form-data">
            ...
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                ...
                <input class="form-control datepicker" id="tanggal_lahir" name="tanggal_lahir" type="text" placeholder="Masukan Tanggal Lahir" required="required">
                <p class="help-block text-danger"></p>
              </div>
            </div>
