...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="school.png"/>
...
include_once("koneksi_db.php");
  ...
  $mahasiswa = mysqli_query($connection, "SELECT *FROM mahasiswa, program_studi WHERE mahasiswa.id_program_studi = program_studi.id_program_studi ORDER BY nrp ASC");
$data = mysqli_query($connection,"SELECT *FROM dosen ORDER BY nip");
?>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
		  ...
		  js-scroll-trigger dropdown-toggle" href="#" id="navbarDropdown"
  ...
  <header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
      ...
      <img class="masthead-avatar mb-5" src="school.png" alt="">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal1">
            ...
            <center><img class="img-fluid" src="studying.png" alt=""></center>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal2">
           ...
           <center><img class="img-fluid" src="student.png" alt=""> </center>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal3">
           ...
           <center> <img class="img-fluid" src="folder.png" alt=""></center>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal4">
           ...
           <center> <img class="img-fluid" src="call.png" alt=""></center>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal5">
           ...
           <center> <img class="img-fluid" src="calendar.png" alt=""></center>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal6">
           ...
           <center> <img class="img-fluid" src="save.png" alt=""></center>
          </div>
        </div>
        ...
        <div class="col-lg-8 mx-auto">
          ...
          <form action="index.php" method="post" novalidate="novalidate">
            ...
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                <label>Message</label>
                <textarea class="form-control" id="messege" name="messege" rows="5" placeholder="messege" required="required" data-validation-required-message="Please enter a message."></textarea>
                <p class="help-block text-danger"></p>
              </div>
            </div>
            <br>
		  ...
		  if(isset($_POST['submit'])){
			  ...
			  $result = mysqli_query($connection, "INSERT INTO contact_me VALUES('','$name','$email','$phone','$messege')");
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4 mb-5 mb-lg-0">
          ...
          <p class="lead mb-0">Jln Sadang Serang
            <br>No 28A</p>
        </div>
        ...
        <div class="col-lg-4 mb-5 mb-lg-0">
          ...
          <a class="btn btn-outline-light btn-social mx-1" href="http://twitter.com/">
              ...
              <div class="col-lg-8">
				...
				<div>
					<table class="table table-striped">
						...
						<?php
                        $no = 1;
                        while($data_dosen = mysqli_fetch_array($data)) {
                          echo"<tr>";
                          echo "<td>".$no++,"</td>";
						  ...
						  <a class='btn btn-danger'  href='delete_dosen.php?nip=$data_dosen[nip]'><i class='fas fa-trash fa-fw'></i>Delete</a></td></tr>";
                        }
                      ?>
						</tbody>
					</table>
