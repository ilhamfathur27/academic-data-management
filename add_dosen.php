...
<?php
  ...
  if (isset($_POST['Submit'])){
    ...
    echo '<div class= "alert alert-primary" role="alert"> Data user berhasil ditambahkan !
    </div>';
          ...
          <form action="add_dosen.php" method="post" enctype="multipart/form-data">
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                <label>NIP</label>
                <input class="form-control" id="nip" name="nip" type="text" placeholder="Masukan Nip" required="required">
            ...
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                ...
                <input class="form-control" id="jabatan_akademik" name="jabatan_akademik" type="text" placeholder="Masukan Jabatan Akademik" required="required">
                <p class="help-block text-danger"></p>
              </div>
            </div>
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                ...
                <input class="form-control" id="prodi" name="prodi" type="text" placeholder="Masukan Prodi" required="required">
                <p class="help-block text-danger"></p>
              </div>
            </div>
            <br>
