...
// Create database connection using config file
	...
	if(isset($_POST['update'])){
		...
		echo '<div class="alert alert-primary" role="alert"> Data user berhasil diperbarui !</div>';
...
?>
 ...
 <!-- Navigation -->
  <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" nip="mainNav">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" nip="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#edit-dosen">Edit Dosen</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <br>
  <!-- Contact Section -->
  <section class="page-section" id="edit-dosen-dosen">
    <div class="container">
          ...
          <form action="edit_dosen.php" method="post">
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                <label>NIP</label>
                <input class="form-control" name="nip" type="text" value='<?php echo $nip; ?>' required="required" disabled>
            ...
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                ...
                <input class="form-control" name="jabatan_akademik" type="text" value='<?php echo $jabatan_akademik; ?>' required="required"></input>
                <p class="help-block text-danger"></p>
              </div>
            </div>
            <div class="control-group">
